interface GLFWObject {}

interface GLFWMonitor extends GLFWObject {}
interface GLFWWindow extends GLFWObject {}
interface GLFWCursor extends GLFWObject {}

interface GLFW {
    makeContextCurrent: (_window: GLFWWindow) => void;
    ...
    setErrorCallback: (cb: (err: number, description: string) => void) => void;
    createStandardCursor: (shape: number) => number;
    destroyCursor: (_cursor: number) => void;
    getClipboardString: (_window: GLFWWindow) => string;
    getCursorPos: (_window: GLFWWindow) => { xpos: number, ypos: number };
    getInputMode: (_window: GLFWWindow, mode: number) => number;
    getJoystickAxes: (joy: number) => number[];
    getJoystickButtons: (joy: number) => number[];
    getJoystickName: (joy: number) => string;
    getKey: (_window: GLFWWindow, key: number) => number;
    getKeyName: (key: number, scancode: number) => string;
    getMouseButton: (_window: GLFWWindow, button: number) => number;
    getTime: () => number;
    getTimerFrequency: () => number;
    getTimerValue: () => number;
    joystickPresent: (joy: number) => boolean;
    setClipboardString: (_window: GLFWWindow, content: string) => void;
    setCursor: (_window: GLFWWindow, _cursor: GLFWCursor) => void;
    setCursorPos: (_window: GLFWWindow, xpos: number, ypos: number) => void;
    setCursorPosCallback: (_window: GLFWWindow, cb: (_window: GLFWWindow, xpos: number, ypos: number) => void) => void;
    setInputMode: (_window: GLFWWindow, mode: number, value: number) => void;
    setKeyCallback: (_window: GLFWWindow, cb: (_window: GLFWWindow, key: number, scancode: number, action: number, mods: number) => void) => void;
    setMouseButtonCallback: (_window: GLFWWindow, cb: (_window: GLFWWindow, button: number, action: number, mods: number) => void) => void;
    setTime: (time: number) => void;
    getMonitors: Function;
    windowHint: (hint: number, value: number) => void;
    createWindow: (width: number, height: number, title: string, _monitor?: GLFWMonitor, _share?: GLFWWindow) => number;
    destroyWindow: (_window: GLFWWindow) => void;
    windowShouldClose: (_window: GLFWWindow) => boolean;
    setWindowTitle: (_window: GLFWWindow, title: string) => void;
    getWindowSize: (_window: GLFWWindow) => { width: number, height: number };
    setWindowSize: (_window: GLFWWindow, width: number, height: number) => void;
    getFramebufferSize: (_window: GLFWWindow) => { width: number, height: number };
    setWindowSizeCallback: (_window: GLFWWindow, cb: (_window: GLFWWindow, width: number, height: number) => void) => void;
    setWindowCloseCallback: (_window: GLFWWindow, cb: (_window: GLFWWindow) => void) => void;
    setFramebufferSizeCallback: (_window: GLFWWindow, cb: (_window: GLFWWindow, width: number, height: number) => void) => void;
    pollEvents: () => void;
    swapBuffers: (_window: GLFWWindow) => void;
